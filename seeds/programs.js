  ...
  return knex('programs').del()
    .then(function () {
      ...
      return knex('programs').insert([
        ...
        { image_name: 'programs/', image_url:'https://augustana-elc-files.s3-us-west-1.amazonaws.com/programs/sandboy.jpg', name: 'Art Program', body: 'Our art activities enable children to explore a variety of media and experiment with color, design and construction.' },
