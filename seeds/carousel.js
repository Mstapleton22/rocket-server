  ...
  return knex('carousel').del()
    .then(function () {
      ...
      return knex('carousel').insert([
        ...
        {id:4, image_name: 'carousel/frontdoor.jpg', image_url: 'https://elcdenver.s3-us-west-1.amazonaws.com/carousel/frontdoor-1.jpg', quote: "The music program literally brings music to my ears! This is one of the reasons we chose AELC as a family.", quoter: "Jared, Lexi and Michelle Growski" },
