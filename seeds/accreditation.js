  ...
  return knex('accreditation').del()
    .then(function () {
      ...
      return knex('accreditation').insert([
        {id: 1, name:'accred_1', image_name: 'accreditations/COShines_Accreditation.png', image_url: 'https://elcdenver.s3-us-west-1.amazonaws.com/accreditations/ECADAlogo.gif' },
